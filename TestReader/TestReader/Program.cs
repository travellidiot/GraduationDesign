...
namespace TestReader
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string bodyPath = Path.Combine(myPhotos, "BodyIndex-11-44-12.bi");
            string skeletonPath = Path.Combine(myPhotos, "SkeletonData-11-44-12.skt");
            string colorPath = Path.Combine(myPhotos, "ColorImage-11-44-12.png");
            string depthPath = Path.Combine(myPhotos, "DepthData-11-44-12.dp");
